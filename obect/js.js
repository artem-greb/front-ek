test ={
    question_arr : ["1. Год создания?", "Сколько магазинов в Харькове?", "Средняя зарплата за месяц?"],
    a1_arr : ["2010", "10", "15 000"],
    a2_arr : ["2013", "17", "25 000"],
    a3_arr : ["2015", "9", "20 000"],
    answer_arr : [ "2010", "9","25 000"],
    n_right_answer_arr: [1,3,2],
}
let n_answer = 2;
let right_answers = 0;
